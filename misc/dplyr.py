...
keymap = {
    ...
    "deplyr filter": ["filter()", Key("left")],
    "deplyr mutate": ["mutate()", Key("left")],
    "deplyr select": ["select()", Key("left")],
    "deplyr summarize": ["summarise()", Key("left")],
    "deplyr rename": ["rename()", Key("left")],
    "deplyr group by": ["group_by()", Key("left")],
    "deplyr transmute": ["transmute()", Key("left")],

    "deplyr filter if": ["filter_if()", Key("left")],
    "deplyr mutate if": ["mutate_if()", Key("left")],
    "deplyr select if": ["select_if()", Key("left")],
    ...
    "deplyr select at": ["select_at()", Key("left")],
    "deplyr summarize at": ["summarise_at()", Key("left")],
    "deplyr rename at": ["rename_at()", Key("left")],
    "deplyr group at": ["group_by_at()", Key("left")],
    "deplyr transmute at": ["transmute_at()", Key("left")],

    "deplyr filter all": ["filter_all()", Key("left")],
    "deplyr mutate all": ["mutate_all()", Key("left")],
    "deplyr select all": ["select_all()", Key("left")],
    "deplyr summarize all": ["summarise_all()", Key("left")],
    "deplyr rename all": ["rename_all()", Key("left")],
    "deplyr group by all": ["group_by_all()", Key("left")],
    "deplyr transmute all": ["transmute_all()", Key("left")],
